...
@section('header', trans('terms.breadcrumbs.create'))
                ...
                <form action="{{ route('admin.terms.store') }}" method="POST">
                    ...
                    <table class="table table-twocols">
                                 ...
                                 <select name="category_id" id="category_id" class="selectpicker form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }}" data-live-search="true" title="@lang('app.selectpicker.title')" required>
                                    @foreach ($categories as $category)
                                        ...
                                        @foreach ($category->children as $child)
                                            <option value="{{ $child->id }}" {{ oldSelected('category_id', $child->id) }}>{{ $child->name }}</option>
                                        @endforeach
                                        </optgroup>
                                    @endforeach
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group twoInOne">
                                    <input id="start_date" type="text" class="form-control js-datepicker{{ $errors->has('start') ? ' is-invalid' : '' }}" name="start" value="{{ old('start')}}" required>
                                ...
                                <div class="input-group twoInOne">
                                    <input id="end_date" type="text" data-fp-mindate="#start_date" class="form-control js-datepicker{{ $errors->has('end') ? ' is-invalid' : '' }}" name="end" value="{{ old('end') }}" required>
                                    <div class="input-group-append">
                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                    @error('end')
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="opening" type="text" data-enabletime class="form-control js-datepicker{{ $errors->has('opening') ? ' is-invalid' : '' }}" name="opening" value="{{ old('opening') }}">
                                    <div class="input-group-append">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="note_public" class="form-control{{ $errors->has('note_public') ? ' is-invalid' : '' }}" name="note_public">{{ old('note_public') }}</textarea>
                                @error('note_public')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="note_private" id="note_private" rows="5" class="form-control{{ $errors->has('note_private') ? ' is-invalid' : '' }}">{{ old('note_private') }}</textarea>
                                @error('note_private')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input type="submit" class="btn btn-primary" value="@lang('terms.form.submit_create')">
                            </td>
                        </tr>
